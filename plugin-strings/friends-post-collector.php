<?php
/**
 * Translatable Strings for the "Friends Post Collector" Plugin
 *
 * Since the plugins are self-hosted, no language packs are available.
 *
 * You can get this plugin at https://github.com/akirk/friends-post-collector
 *
 * @package Friends
 */

// Name of the Friends Post Collector plugin.
__( 'Friends Post Collector', 'friends' );
// Description of the Friends Post Collector plugin.
...
__( 'About', 'friends' );
__( 'Default User', 'friends' );
// translators: %s is a role name.
__( 'Please select a user under which external posts should be saved by default. Only users with the <em>%s</em> role are shown.', 'friends' );
// translators: %s is a role name.
