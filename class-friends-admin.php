	...
	public function toolbox_bookmarklets() {
		...
		<div class="card">
			...
			<p>
				...
				<a onclick="alert( '<?php echo esc_attr( __( 'Please drag this to your bookmarks bar.', 'friends' ) ); ?>' );return false" href="javascript:void(location.href='<?php echo esc_attr( self_admin_url( 'admin-ajax.php?action=friends_save_bookmark&url=' ) ); ?>'+encodeURIComponent(location.href))" style="display: inline-block; padding: .5em; border: 1px solid #999; border-radius: 4px; background-color: #ddd; text-decoration: none; margin-right: 3em"><?php echo esc_html_e( 'Save Article', 'friends' ); ?></a>
			</p>
			</div>
		</div>
		<?php
