...
?><div class="plugin-card plugin-card-<?php echo esc_attr( $api->slug ); ?>">
	<div class="plugin-card-top">
		<div class="name column-name">
			<h3>
				<a target="_blank" href="<?php echo esc_url( $more_info_url ); ?>"><?php echo esc_html( $api->name ); ?> <?php echo esc_html( $api->version ); ?></a>
			</h3>
		</div>
	...
	<div class="plugin-card-bottom">
		...
		&nbsp; <a href="<?php echo esc_url( $more_info_url ); ?>" style="line-height: 2.3em;" target="_blank" aria-label="<?php /* phpcs:ignore WordPress.WP.I18n.MissingArgDomain */ echo /* translators: %s is a plugin name. */ esc_html( sprintf( __( 'More information about %s' ), $api->name ) ); ?>" data-title="<?php echo esc_attr( $api->name ); ?>"><?php esc_html_e( 'More Details' ); ?></a>
