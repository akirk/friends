...
<ul>
	...
	<li>
		...
		<ul>
			...
			<li><a href="<?php echo \esc_url_raw( \admin_url( 'admin.php?tab=friends-plugins' ) ); ?>"><?php \esc_html_e( 'Post Collection Plugin', 'friends' ); ?></a>: <span><?php esc_html_e( 'Collect posts from around the web and create feeds.', 'friends' ); ?></span> </li>
			<li><a href="<?php echo \esc_url_raw( \admin_url( 'admin.php?tab=friends-plugins' ) ); ?>"><?php \esc_html_e( 'Send to E-Reader Plugin', 'friends' ); ?></a>: <span><?php esc_html_e( 'Send new articles directly to your e-reader via e-mail or download the ePub.', 'friends' ); ?></span> </li>
		</ul>
	</li>
</ul>
