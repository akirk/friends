	...
	<?php while ( have_posts() ) : ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header class="entry-header">
				...
				<h4 class="entry-title"><a href="<?php the_permalink(); ?>" target="_blank" rel="noopener noreferrer" rel="bookmark"
																		<?php
																		if ( Friends::FRIEND_POST_CACHE === get_post_type() ) {
																			echo ' class="auth-link" data-token="' . esc_attr( $token ) . '"';}
?>
><?php the_title(); ?></a></h4>
			</header>
