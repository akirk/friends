...
?>
<?php get_header(); ?>
<h1><a href="<?php echo site_url( '/friends/' ); ?>">Friends</a></h1>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header class="entry-header">
			<?php if ( Friends::FRIEND_POST_CACHE === get_post_type() ) : ?>
				<a href="<?php echo esc_url( get_the_author_meta( 'url' ) ); ?>" class="author-avatar auth-link" data-token="<?php echo esc_attr( $token ); ?>" target="_blank" rel="noopener noreferrer">
			...
			<span class="post-meta">
				...
				<span class="post-comment"> &nbsp;|&nbsp; <a href="<?php comments_link(); ?>" target="_blank" rel="noopener noreferrer" class="auth-link" data-token="<?php echo esc_attr( $token ); ?>"><?php comments_number(); ?></a></span>
				<?php if ( Friends::FRIEND_POST_CACHE !== get_post_type() ) : ?>
				<?php endif; ?>
			</span>
			...
			<h4 class="entry-title">
				<?php if ( Friends::FRIEND_POST_CACHE === get_post_type() ) : ?>
					<a href="<?php the_permalink(); ?>" target="_blank" rel="noopener noreferrer" rel="bookmark" class="auth-link" data-token="<?php echo esc_attr( $token ); ?>"><?php the_title(); ?></a>
				<?php else : ?>
					<a href="<?php the_permalink(); ?>" target="_blank" rel="noopener noreferrer" rel="bookmark"><?php the_title(); ?></a>
				<?php endif; ?>
			</h4>
		</header>
